...
class App extends Component {
  ...
  handleSelecedUser = property => {
      this.setState({ selectedUser: property })
      //go to topics page
      this.setSelectedView("Topics")

  }
  handleSelecedTopic = property => {
       
        var stopics = this.state.topics
        if (stopics.length > 0) {
            stopics += "," + property
        } else {
            stopics=property
                ...
                >
                  ...
                  >
                    ...
                    className={classes.user}
                              >
                                  <p>{this.state.selectedUser.length > 0 ? (
                                      "Member: " + this.state.selectedUser) : this.state.selectedUser}
                                  </p>        
                                  <p>{this.state.topics.length > 0 ? (
                                      "Interests: " + this.state.topics) : this.state.topics}
                                  </p>        
                  ...
                  <List>
                    <div>
                      ...
                      >
                       ...
                       <ListItem
                            button
                            onClick={() => this.setSelectedView("Members")}
                            >
                       <ListItemIcon>
                              <GroupIcon />
                        </ListItemIcon>
                      ...
                      <ListItem
                        button
                        onClick={() => this.setSelectedView("Topics")}
                      >
                        <ListItemIcon>
                          <InterestsIcon />
                        </ListItemIcon>
                ...
                <main className={classes.content}>
                  ...
                  >
                    ...
                    {this.state.selectedView === "Users" ? (
                     ...
                     {this.state.selectedView === "Topics" ? (
                                  <TopicList selectedUser={this.state.selectedUser}/>
                              ) : null}
                     {this.state.selectedView === "Members" ? (
                                  <MemberList callbackFromParent={this.handleSelecedUser}/>
                              ) : null}
                  </Typography>
                </main>
              </div>
